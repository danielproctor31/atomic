...
# install fonts
curl -fLo "/usr/share/fonts/nerdfonts/Caskaydia Cove Nerd Font Complete Regular.otf" \
...
curl -fLo "/usr/share/fonts/nerdfonts/Caskaydia Cove Nerd Font Complete Mono.otf" \
...
fc-cache -f /usr/share/fonts/nerdfonts
